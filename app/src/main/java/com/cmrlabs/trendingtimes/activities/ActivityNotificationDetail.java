...
import com.cmrlabs.trendingtimes.callbacks.CallbackNewsDetail;
import com.cmrlabs.trendingtimes.models.News;
import com.cmrlabs.trendingtimes.realm.RealmController;
import com.cmrlabs.trendingtimes.rests.ApiInterface;
import com.cmrlabs.trendingtimes.rests.RestAdapter;
import com.cmrlabs.trendingtimes.utils.AppBarLayoutBehavior;
import com.cmrlabs.trendingtimes.utils.Constant;
import com.cmrlabs.trendingtimes.utils.NetworkCheck;
import com.cmrlabs.trendingtimes.utils.Tools;
...
public class ActivityNotificationDetail extends AppCompatActivity {
    ...
    TextView txt_title, txt_category, txt_date, txt_comment_count, txt_comment_text, txt_news_url;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_news_url = findViewById(R.id.news_url);
    ...
    private void displayData() {
        ...
        txt_news_url.setText(post.news_url);
        ...
        if (post.content_type != null && post.content_type.equals("youtube")) {
           ...
           /* Picasso.with(this)
                    ...
                    .placeholder(R.drawable.ic_thumbnail)
                    .into(news_image); */
            if (post.news_image.isEmpty()) {
                news_image.setImageResource(R.drawable.ic_thumbnail);
            } else {

                Picasso.with(this)
                        .load(post.news_image.replace(" ", "%20"))
                        .placeholder(R.drawable.ic_thumbnail)
                        .into(news_image);
            }
            news_image.setOnClickListener(new View.OnClickListener() {
    ...
    private void displayDataRTL() {
        ...
        if (post.content_type != null && post.content_type.equals("youtube")) {
           ...
           /* Picasso.with(this)
                    .load(Config.ADMIN_PANEL_URL + "/upload/" + post.news_image.replace(" ", "%20"))
                    .placeholder(R.drawable.ic_thumbnail)
                    .into(news_image);*/ Picasso.with(this)
                    .load(post.news_image.replace(" ", "%20"))
                    .placeholder(R.drawable.ic_thumbnail)
                    .into(news_image);
