...
import com.cmrlabs.trendingtimes.fragment.FragmentCategory;
import com.cmrlabs.trendingtimes.fragment.FragmentFavorite;
import com.cmrlabs.trendingtimes.fragment.FragmentProfile;
import com.cmrlabs.trendingtimes.fragment.FragmentRecent;
import com.cmrlabs.trendingtimes.fragment.FragmentVideo;
import com.cmrlabs.trendingtimes.utils.AppBarLayoutBehavior;
import com.cmrlabs.trendingtimes.utils.BottomNavigationViewHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (message != null) {
            ...
            if (imageUrl.endsWith(".jpg") || imageUrl.endsWith(".jpeg") || imageUrl.endsWith(".png") || imageUrl.endsWith(".gif")) {
                ...
                if (imageUrl.isEmpty()) {
                    notification_image.setImageResource(R.drawable.ic_thumbnail);
                } else {
