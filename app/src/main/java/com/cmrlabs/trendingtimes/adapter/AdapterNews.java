...
public class AdapterNews extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public class OriginalViewHolder extends RecyclerView.ViewHolder {
        ...
        public OriginalViewHolder(View v) {
            ...
            news_url = v.findViewById(R.id.news_url);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof OriginalViewHolder) {
            ...
            vItem.news_url.setText(p.news_url);
            ...
            if (p.content_type != null && p.content_type.equals("youtube")) {
                if (p.news_image.isEmpty()) {
                    vItem.image.setImageResource(R.drawable.ic_thumbnail);
                } else {
        ...
        /*else if (position % 5 == 00) {

            Log.println(position, "POSITION", "SHOW AD HERE");
