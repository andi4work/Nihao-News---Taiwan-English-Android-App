package com.cmrlabs.trendingtimes.utils;

import com.cmrlabs.trendingtimes.Config;

import static com.cmrlabs.trendingtimes.Config.ADMIN_PANEL_URL;
...
public class Constant {
    ...
    public static final String FETCH_NEWS_URL = ADMIN_PANEL_URL + "/api/fetch_news/?email=";
